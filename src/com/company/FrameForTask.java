...
public class FrameForTask {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Task_3");
        ...
        panel.add(table());
        panel.add(buttonForArrayDeque(panel));
        ...
        panel.add(buttonForMyQueue(panel));
        frame.add(panel);
    ...
    static JButton buttonForArrayDeque(JPanel panel) {
        JButton button = new JButton("ArrayDeque");
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    for (int i = 0; i < table.getColumnCount(); i++) {
                        deque.add(Integer.parseInt(table.getValueAt(0, i).toString()));
                    }
                    Logic.function(deque);
                    int i = 0;
                    while (!deque.isEmpty()) {
                        table.setValueAt(deque.pollFirst(), 0, i++);
                    }
                } catch (Exception e1) {
                    JOptionPane.showMessageDialog(null, "Input a positive integer");
                }
            }
        });
        return button;
    ...
    static JButton buttonForMyQueue(JPanel panel) {
        JButton button = new JButton("MyQueue");
        ...
        button.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    for (int i = 0; i < table.getColumnCount(); i++) {
                        queue.add(Integer.parseInt(table.getValueAt(0, i).toString()));
                    }
